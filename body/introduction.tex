...
92 \fi
\end{lstlisting}
\BiSection{配置}{Intray of compiling}

\BiSection{X置}{Introduche \XeLaTeX way of compiling}
...
\BiSection{群介绍}{Introduction to the QQ groups for \LaTeX~technical exchange in HIT}
