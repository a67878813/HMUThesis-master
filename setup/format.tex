...
\titlespacing{\section}{2em}{0mm}{0mm}
\titleformat{\subsection}{\song\bfseries\xiaosi}{\thesubsection}{0.5em}{}
\titlespacing{\subsection}{2em}{0mm}{0mm}
\titleformat{\subsubsection}{\song\bfseries\xiaosi}{\thesubsubsection}{0.5em}{}
...
\ifxueweidoctor
\fancyhead[CO]{\song \xiaowu 哈尔滨医科大学外科学(X外)学位论文}
\fancyhead[CE]{\song \xiaowu 哈尔滨医科大学外科学(X外)学位论文}%
...
%    \fi
 ...
 %   \begin{center} {\hei  \@ctitle}\end{center} }
	...
	%\@cassosupervisor
	%\@ccosupervisor
	{~~} & \medthss@int@fillinblank{1}{11.5cm}{\bfseries ~~脊柱发育模型的建立与验证~~}\\%在此处填写第二行标题
    ...
    {\hei\xiaosan 指导\hfill 教师} & \medthss@int@fillinblank{1}{11.5cm}{\bfseries \@csupervisor}\\
  %  {\hei 授予学位单位}                     & 哈尔滨医科大学
  %\medthss@int@fillinblank{1}{\medthss@tmp@len}{\@cauthor}
    \end{tabular} 
	\\
	\rule{0pt}{23pt}\\
	\sanhao\song \bfseries \@cdate
